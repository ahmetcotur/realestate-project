...
Route::prefix('admin')->name('admin.')->middleware('web')->middleware('auth')->middleware(\App\Http\Middleware\AdminPanelAccess::class)->group(function () {
    ...
    Route::put('/settings/contact', [App\Http\Controllers\Admin\SettingsController::class, 'updateContact'])->name('settings.update.contact');
    Route::put('/settings/social', [App\Http\Controllers\Admin\SettingsController::class, 'updateSocial'])->name('settings.update.social');
    Route::put('/settings/home', [App\Http\Controllers\Admin\SettingsController::class, 'updateHome'])->name('settings.update.home');
    Route::put('/settings/about', [App\Http\Controllers\Admin\SettingsController::class, 'updateAbout'])->name('settings.update.about');
    Route::put('/settings/properties', [App\Http\Controllers\Admin\SettingsController::class, 'updateProperties'])->name('settings.update.properties');
    Route::put('/settings/agents', [App\Http\Controllers\Admin\SettingsController::class, 'updateAgents'])->name('settings.update.agents');
    Route::put('/settings/contact-page', [App\Http\Controllers\Admin\SettingsController::class, 'updateContactPage'])->name('settings.update.contact-page');
    Route::put('/settings/footer', [App\Http\Controllers\Admin\SettingsController::class, 'updateFooter'])->name('settings.update.footer');
});
