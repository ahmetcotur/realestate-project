...
@section('title', 'Emlak İlanı Düzenle')
        ...
        <div class="md:flex md:items-center md:justify-between mb-6">
            <div class="flex-1 min-w-0">
                <h2 class="text-2xl font-semibold leading-tight text-gray-800">
                    Emlak İlanı Düzenle: {{ $property->title_tr }}
                </h2>
            </div>
                ...
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="mt-1">
                                <input type="text" name="title_tr" id="title_tr" value="{{ old('title_tr', $property->title_tr) }}" required 
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="mt-1">
                                <input type="text" name="title_en" id="title_en" value="{{ old('title_en', $property->title_en) }}" 
                                    class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md">
                            </div>
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="mt-1">
                                <textarea name="description_tr" id="description_tr" rows="4" required 
                                    class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md">{{ old('description_tr', $property->description_tr) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="mt-1">
                                <textarea name="description_en" id="description_en" rows="4" 
                                    class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md">{{ old('description_en', $property->description_en) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="mt-1">
                                <select name="currency" id="currency" 
                                    class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                    <option value="TRY" {{ (old('currency', $property->currency) == 'TRY') ? 'selected' : '' }}>TL</option>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="mt-1">
                                <input type="text" name="district" id="district" value="{{ old('district', $property->district) }}" 
                                    class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md">
                            </div>
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="mt-1">
                                <input type="number" name="area" id="area" value="{{ old('area', $property->area) }}" 
                                    class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md" 
                                    min="0" step="1">
                            </div>
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="mt-1">
                                <select name="listing_type" id="listing_type" required
                                    class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                    <option value="">Seçiniz</option>
                                    <option value="sale" {{ old('listing_type', $property->status == 'sale' ? 'sale' : '') == 'sale' ? 'selected' : '' }}>Satılık</option>
                                    <option value="rent" {{ old('listing_type', $property->status == 'rent' ? 'rent' : '') == 'rent' ? 'selected' : '' }}>Kiralık</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="mt-1">
                                <select name="status" id="status" 
                                    ...
                                    <option value="pending" {{ old('status', $property->status) == 'pending' ? 'selected' : '' }}>Beklemede</option>
                                    <option value="sold" {{ old('status', $property->status) == 'sold' ? 'selected' : '' }}>Satıldı</option>
                                    <option value="rented" {{ old('status', $property->status) == 'rented' ? 'selected' : '' }}>Kiralandı</option>
                                </select>
                            </div>
                        </div>
