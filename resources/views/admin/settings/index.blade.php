...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div id="content-contact" class="settings-content hidden p-6">
        ...
        <div id="content-social" class="settings-content hidden p-6">
        ...
        <div id="content-properties" class="settings-content p-6 hidden">
            <form action="{{ route('admin.settings.properties') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
        ...
        <div id="content-agents" class="settings-content p-6 hidden">
            <form action="{{ route('admin.settings.agents') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
        ...
        <div id="content-contact-page" class="settings-content p-6 hidden">
            <form action="{{ route('admin.settings.contact-page') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
        ...
        <div id="content-footer" class="settings-content p-6 hidden">
            <form action="{{ route('admin.settings.footer') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
